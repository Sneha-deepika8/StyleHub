...
export default function Login() {
  ...
  // Handle Social Login
  const handleSocialLogin = async (providerName, loginMethod) => {
    setError("");
    setIsLoading(true);
    try {
      await loginMethod();
      ...
      <div className="auth-container">
        ...
        <div className="auth-branding">
          ...
          <div className="auth-hero">
            <h1>Welcome Back!</h1>
            <p>Your style journey continues here. Sign in to explore exclusive collections and amazing deals.</p>
          </div>
